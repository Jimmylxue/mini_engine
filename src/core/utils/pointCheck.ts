import { TMouseEvent, TShape } from 'types/types'
import { Circle, Image, Rect } from '@views/index'

function checkRect(mouse: TMouseEvent, shape: Rect | Image): boolean {
...
function checkCircle(mouse: TMouseEvent, shape: Circle): boolean {
